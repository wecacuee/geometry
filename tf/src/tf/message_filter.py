"""
Transform message filter equivalent to tf::MessageFitler< > in roscpp

Usage::

    from sensor_msgs.msg import Image

    def callback(image, (trans, rotation)):
    ...
    ts = TfMessageFilter(image_sub, '/base_frame', '/target_frame', queue_size=200)
